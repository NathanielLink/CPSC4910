...
public class Feedback {
	...
	public Integer getFeedback() throws InstantiationException, IllegalAccessException, ClassNotFoundException {
		...
		PreparedStatement ResponseStatement = connect.prepareStatement(Response);
		...
		int Trip_id = 0;
		Statement LookupTrip_id = connect.createStatement();
		...
		PreparedStatement TripsStatement = connect.prepareStatement(Trips);
